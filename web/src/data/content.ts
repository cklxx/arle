    ...
    stats: [
      {
        ...
        num: "197",
        unit: "tok/s",
        meta: 'conc=<b>16</b> · FP8 KV (auto)',
        spark: "M0 13 L8 12 L16 11 L24 9 L32 8 L40 6 L48 4 L60 2",
      },
      {
        lbl: "cuda · L4 · vs legacy",
        num: "+64",
        unit: "%",
        meta: '<b>2026-04-28</b> · 120→197 tok/s',
        spark: "M0 12 L8 11 L16 9 L24 7 L32 5 L40 4 L48 3 L60 2",
      },
      {
      ...
      rows: [
        {
          ...
          backend: "cuda",
          model: "Qwen3-4B",
          hardware: "NVIDIA L4 · BF16 + FP8 paged KV (auto)",
          metric: 'out <b>197 tok/s</b> &middot; ITL p50 <b>77.9 ms</b> &middot; conc=16 (saturated) &middot; +64% vs legacy',
          ...
          grid: [
            {
              ...
              value: "197",
              unit: "tok/s",
              spark: "M0 14 L10 12 L20 11 L30 9 L40 7 L50 5 L64 3",
            },
            {
              label: "ITL p50",
              value: "77.9",
              unit: "ms",
              spark: "M0 8 L10 8 L20 7 L30 9 L40 9 L50 11 L64 13",
            },
            { label: "peak_active", value: "16", unit: "/ 16" },
            { label: "peak kv util", value: "69", unit: "%" },
          ],
        },
        {
          date: "2026-04-27",
      ...
      rows: [
        {
          ...
          model: "Qwen3-4B",
          hardware: "NVIDIA L4 · BF16 + FP8 paged KV（auto）",
          metric: '输出 <b>197 tok/s</b> &middot; ITL p50 <b>77.9 ms</b> &middot; conc=16（满槽）&middot; +64% vs legacy',
          href: "https://github.com/cklxx/arle/blob/main/docs/experience/wins/2026-04-28-bench-guidellm-cuda-l4-kv-fp8-auto.md",
          stability: "stable",
          cmd: "scripts/bench_guidellm.sh cuda-l4-hbm-tier-fp8-auto",
          grid: [
