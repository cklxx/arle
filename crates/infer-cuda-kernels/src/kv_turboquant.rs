...
use crate::turboquant_state::{RotationMode, TurboQuantLayerState};
...
pub fn turboquant_quantize_paged_single(
    ctx: &DeviceContext,
    kv_bf16_ptr: u64,
...
#[allow(clippy::too_many_arguments)]
#[allow(dead_code)]
pub fn turboquant_dequantize_inplace(
    ctx: &DeviceContext,
    pool_data: &CudaSlice<u8>,
    pool_norms: &CudaSlice<u16>,
    work_bf16_ptr: u64,
...
#[allow(clippy::too_many_arguments)]
pub fn turboquant_rotate_query(
    ctx: &DeviceContext,
    q_ptr: u64,
    q_rot_ptr: u64,
    state: &TurboQuantLayerState,
...
#[allow(clippy::too_many_arguments)]
pub fn turboquant_fused_decode_attention(
    ctx: &DeviceContext,
    q_rot_ptr: u64,
