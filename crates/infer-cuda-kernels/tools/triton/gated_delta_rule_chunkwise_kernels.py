...
def gdr_solve_tril_64_qwen35_kernel(
    ...
    Qwen3.5 runtime shape and Triton AOT constraints used by infer.
    """
    chunk_idx = tl.program_id(0)
    v_head = tl.program_id(1)
...
def gdr_chunk_state_qwen35_kernel(
    ...
    for infer's fixed Qwen3.5 runtime and decode-state contract.
...
def gdr_chunk_o_qwen35_kernel(
    ...
    fixed-shape Qwen3.5 runtime path used by infer.
