...
impl SchedulerConfig {
    ...
    pub fn runtime_defaults(max_slots: usize) -> Self {
        Self {
            max_slots,
            // sglang L4 default (server_args.py:1169-1172): 20-35 GB GPU →
            // chunked_prefill_size=2048. Halving lets c=16 admission advance
            // 2 requests per tick instead of serializing.
