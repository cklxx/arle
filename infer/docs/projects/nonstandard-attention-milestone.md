...
**Status**: Active
**TL;DR**: infer is focused on inference and serving for non-standard attention models, especially linear attention and sparse attention. This milestone prioritizes model-family readiness, service experience, framework debt repayment, and disciplined correctness/performance evaluation.

---

## Goal

infer should become a strong runtime and serving foundation for non-standard attention models.
