...
- chunk-wise scratch / contract code compiles in infer
- multi-stage Triton AOT build scaffolding compiles in infer
...
- one end-to-end prefill path in infer can exercise the chunk-wise operator
