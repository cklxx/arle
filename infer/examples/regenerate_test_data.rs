//! Regenerate test_data/Qwen3-4B.json using infer's greedy output.
//! Run: cargo run -r --example regenerate_test_data

use infer::model::{GenerationState, ModelForward, ModelRuntimeConfig, Qwen3Model};
