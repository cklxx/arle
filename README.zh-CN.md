...
| **Metal** | Apple Silicon | **Beta** | 调度器驱动的实时服务、chunked prefill、replay-based prefix 复用，Qwen3.5-0.8B GGUF Q4_K_M 在 M4 Pro 上 decode 211.7 tok/s。 |
...
模型：**Qwen3 (0.6B – 72B)** 与 **Qwen3.5 系列**（包括 0.8B GGUF Q4_K_M、4B 混合线性 + 全注意力）按当前矩阵已支持 CUDA 与 Metal。**Qwen3.6 / Qwen3.5-MoE** 目前是窄 Metal Beta 路径，CUDA 仍是 stub。Llama 3 / 4、DeepSeek V3 / R1 在路线图上 —— 见 [ROADMAP.md](ROADMAP.md)。
...
- **2026-04-27** — Metal `Qwen3.5-0.8B` GGUF `Q4_K_M` decode 在 M4 Pro 上超过 200 tok/s；本轮落地 Q5_K/Q8_0 affine repack 与 Q6/group16 qmv tile 调整。证据：[`docs/experience/wins/2026-04-27-bench-metal-qwen35-0p8b-gguf-q5-q8-q6qmv.md`](docs/experience/wins/2026-04-27-bench-metal-qwen35-0p8b-gguf-q5-q8-q6qmv.md)。
