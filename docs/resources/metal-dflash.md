...
- **Qwen3.6-35B-A3B-4bit**: 2026-04-27 M4 Pro quick check at
  `prompt=32, generation=256` proved the path still loads and executes, but
  this short shape is not a DFlash acceptance workload. Future DFlash
  optimization and reporting should use long-context / ultra-long-sequence
  prompts only.
